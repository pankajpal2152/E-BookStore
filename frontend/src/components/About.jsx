...
import { Facebook, Twitter, Instagram, Clock, MapPin } from 'lucide-react';
                ...
                <div className={aboutStyles.innerContainer}>
                    <div className={aboutStyles.headingWrapper}>
                        ...
                        <p className={aboutStyles.subText}>
                            Pioneering the next chapter in global storytelling. We bridge imagination with innovation
                            through curated literary experiences.
                        </p>
                    </div>
                </div>
            </section>
