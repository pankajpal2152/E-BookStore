...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const whatsappNumber = '8967890080'
        const textLines = [
            `Name: ${formData.name}`,
                        ...
                        <div className="space-y-6">
                            ...
                            <div className={styles.contactItemStyle}>
                                ...
                                <div>
                                    ...
                                    <p className='text-gray-600'>contact@E-BookStore.com</p>
                                </div>
                            </div>
                            ...
                            <div className={styles.contactItemStyle}>
                                ...
                                <div>
                                    ...
                                    <p className='text-gray-600'>+91 8967890080</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            ...
                            <div className='space-y-2'>
                                ...
                                <div className={styles.inputWrapperStyle}>
                                    ...
                                    <textarea name='message' rows='4' value={formData.message} onChange={handleChange} className={styles.textareaStyle} />
