...
export const navbarStyles = {
  nav: (scrolled) =>
    `fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm transition-all duration-500 ${scrolled ? "shadow-md py-2" : "py-4"
    }`,
...
export const footerStyles = {
  footer: "bg-[#f3f5f7] py-16 mt-16 border-t border-gray-200",
  ...
  logoText: "text-2xl font-semibold text-gray-800",

  aboutText: "text-sm text-gray-600 leading-relaxed max-w-xs",

  socialWrap: "flex items-center space-x-4 pt-2",
  socialButton:
    "h-9 w-9 flex items-center justify-center rounded-full bg-white shadow hover:shadow-md transition",
  socialIcon: "h-4 w-4 text-teal-500",

  /* Quick Links */
  quickLinksBlock: "space-y-4",
  quickLinksTitle: "text-lg font-semibold text-gray-800",
  quickLinksList: "space-y-3",
  quickLinkItem: "flex items-center space-x-2 text-gray-600 hover:text-teal-600",
  quickLinkDot: "h-2 w-2 rounded-full bg-teal-500",

  /* Newsletter */
  newsletterBlock: "space-y-4",
  newsletterTitle: "text-lg font-semibold text-gray-800",
  newsletterText: "text-sm text-gray-600 leading-relaxed",

  formWrap: "flex items-center bg-white rounded-full shadow p-1 pl-4 max-w-sm",
  input:
    "flex-1 outline-none text-sm placeholder-gray-400 bg-transparent",
  button:
    "px-4 py-2 bg-gradient-to-r from-teal-400 to-green-400 rounded-full text-white shadow-md flex items-center justify-center",

  /* Contact */
  contactBlock: "space-y-4",
  contactTitle: "text-lg font-semibold text-gray-800",
  contactList: "space-y-3",

  contactItem: "flex items-start space-x-3 text-gray-600",
  contactIcon: "h-5 w-5 text-teal-500 mt-1",

  contactRow: "flex items-center space-x-3 text-gray-600",
  contactIconInline: "h-5 w-5 text-teal-500",

  /* Copyright */
  copyrightWrap: "border-t border-gray-300 mt-12 pt-8 text-center",
  copyrightText: "text-sm text-gray-600",
};
